...
def draw_IABB(selection, output):
        """
        DESCRIPTION
	...
	dst1 = cmd.distance(None, p4, p7)
	dst2 = cmd.distance(None, p4, p6)
	dst3 = cmd.distance(None, p4, p5)
...
def draw_Protein_Dimensions(selection, output):
	draw_IABB(selection, output)
	cmd.hide("cgo")
